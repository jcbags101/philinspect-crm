...
- On 2026-08-02, the Figma MCP refused further reads because the connected View
  seat had reached its plan call limit. No row was promoted to `matched` from
  cached screenshots or inferred structure.
...
| 01 Overview | responsive dashboard | `/` | 390x844 | partial | `overview-mobile.png` |
...
| 02 Leads Flow | lead create | `/leads/new` | 1440x1000 | partial | `lead-create.png` |
| 02 Leads Flow | lead detail/edit | `/leads/[leadId]` | 1440x1000 | partial | `lead-detail.png` |
| 02 Leads Flow | lead conversion | `/leads/[leadId]` conversion action | 1440x1000 | partial | `lead-convert.png` |
...
| 03 Deals Flow | deal create | `/deals/new` | 1440x1000 | partial | `deal-create.png` |
| 03 Deals Flow | deal active/detail | `/deals/[dealId]` | 1440x1000 | partial | `deal-detail-active.png` |
| 03 Deals Flow | deal activity | `/deals/[dealId]?tab=activity` | 1440x1000 | partial | `deal-activity.png` |
| 03 Deals Flow | deal resources | `/deals/[dealId]?tab=resources` | 1440x1000 | partial | `deal-resources.png` |
| 03 Deals Flow | stage movement | `/deals?fixture=stage-moved` | 1440x1000 | missing | `deals-stage-moved.png` |
| 04 Clients and Users | company list | `/companies` | 1440x1000 | partial | `companies-list.png` |
| 04 Clients and Users | company create | `/companies/new` | 1440x1000 | partial | `company-create.png` |
| 04 Clients and Users | company detail/edit | `/companies/[companyId]` | 1440x1000 | partial | `company-detail.png` |
| 04 Clients and Users | contact list | `/contacts` | 1440x1000 | partial | `contacts-list.png` |
| 04 Clients and Users | contact create | `/contacts/new` | 1440x1000 | partial | `contact-create.png` |
| 04 Clients and Users | contact detail/edit | `/contacts/[contactId]` | 1440x1000 | partial | `contact-detail.png` |
| 04 Clients and Users | users/member list | `/users` | 1440x1000 | partial | `users-list.png` |
| 04 Clients and Users | invite member | `/users` invitation form | 1440x1000 | partial | `users-invite-open.png` |
| 04 Clients and Users | role edit | `/users` member editor | 1440x1000 | partial | `users-role-open.png` |
...
| 06 Business and System | tasks | `/tasks` | 1440x1000 | partial | `tasks-list.png` |
| 06 Business and System | task create/edit | `/tasks/new` and `/tasks/[taskId]/edit` | 1440x1000 | partial | `task-editor.png` |
...
| 07 Inspections Flow | inspection create/edit | `/inspections/new` and `/inspections/[inspectionId]/edit` | 1440x1000 | partial | `inspection-editor.png` |
| 07 Inspections Flow | `Inspection / Report Viewer / Desktop` | `/inspections/[inspectionId]/report` | 1440x1000 | partial | `inspection-report-viewer.png` |
...
| Authentication | no membership | `/auth/access-denied` | 1440x1000 | partial | `onboarding-no-membership.png` |
| Authentication | accept invitation | `/auth/invite/[token]` | 1440x1000 | partial | `invitation-accept.png` |
| Authentication | forbidden | `/forbidden` | 1440x1000 | partial | `forbidden.png` |
